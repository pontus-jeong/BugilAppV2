package bugil.bada.bugilapp.activity.bap;
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                String mShareBapMsg = String.format(getString(R.string.shareBap_message_msg),
                        mData.mCalender, mData.mBreakfast, mData.mLunch, mData.mDinner);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_calender) {
            ...
            if (isNetwork) {
                ...
                mCalendar.add(Calendar.DATE, 1 - DAY_OF_WEEK);
                String mPrefBreakfastName = BapTool.getBapStringFormat(YEAR, MONTH, DAY, BapTool.TYPE_BREAKFAST);
